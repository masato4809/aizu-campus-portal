...
export const Range: React.FC<IProps> = ({
  ...
  // 適用バリデーション.
  const validationList: string[] = ['number_range:20-50'];
  ...
  return (
    ...
    >
      ...
      <InputField
        ...
        inputValue={formInputForm.inputSingleRange}
        onChange={inputSingleRange => handleUpdate({ inputSingleRange })}
        placeHolder="入力してください"
        errors={validation.data.inputSingleRange?.errors}
        visibleError
      />
    </Box>
  );
