...
export const NotZero: React.FC<IProps> = ({
  sx,
  formInputForm,
  validation,
  handleUpdate,
  ...
  return (
    ...
    >
      ...
      <InputField
        ...
        inputValue={formInputForm.inputSingleNotZero}
        onChange={inputSingleNotZero => handleUpdate({ inputSingleNotZero })}
        placeHolder="入力してください"
        errors={validation.data.inputSingleNotZero?.errors}
        visibleError
      />
    </Box>
  );
