...
export const Email: React.FC<IProps> = ({
  sx,
  formInputForm,
  validation,
  handleUpdate,
  ...
  // 適用バリデーション.
  const validationList: string[] = ['email'];
  ...
  return (
    ...
    >
      ...
      <InputField
        ...
        inputValue={formInputForm.inputSingleEmail}
        onChange={inputSingleEmail => handleUpdate({ inputSingleEmail })}
        placeHolder="入力してください"
        errors={validation.data.inputSingleEmail?.errors}
        visibleError
      />
    </Box>
  );
